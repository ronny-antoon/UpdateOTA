...
UpdateOTA::UpdateOTA(DownloaderInterface *downloader, UpdaterInterface *updater, MultiPrinterLoggerInterface *logger)
{
...
UPDATE_OTA_ERROR UpdateOTA::setCACertificate(const char *cACertificate)
{
    ...
    {
        Log_Error(_logger, "CA certificate is too long");
    ...
    {
        Log_Error(_logger, "CA Certificate is empty");
        return UPDATE_OTA_ERROR::INVALID_ARGUMENT;
    }

    Log_Debug(_logger, "CA Certificate Registered.");
...
UPDATE_OTA_ERROR UpdateOTA::updateFirmaware(const char *urlFirmware, const char *urlVersion, const char *currentVersion)
{
    ...
    {
        Log_Error(_logger, "URL is null or empty");
        return UPDATE_OTA_ERROR::INVALID_ARGUMENT;
    }
    ...
    if (strlen(_cACertificate) != 0)
    {
        ...
        {
            Log_Error(_logger, "Error setting CA Certificate");
            return UPDATE_OTA_ERROR::UNKNOWN;
        }
    }
    ...
    if (currentVersion != nullptr && strlen(currentVersion) != 0)
    {
        ...
        {
            Log_Error(_logger, "Error setting URL for version file");
            return UPDATE_OTA_ERROR::UNKNOWN;
        }
        ...
        {
            Log_Error(_logger, "Error getting server version");
            return UPDATE_OTA_ERROR::UNKNOWN;
        }
        ...
        {
            Log_Debug(_logger, "Newer version found");
        }
        else
        {
            Log_Debug(_logger, "No newer version found");
    ...
    {
        Log_Error(_logger, "Error setting URL for bin file");
        return UPDATE_OTA_ERROR::UNKNOWN;
    }
    ...
    {
        Log_Error(_logger, "Error downloading bin file");
        return UPDATE_OTA_ERROR::UNKNOWN;
    }
    ...
    {
        Log_Error(_logger, "Error updating firmware");
        return UPDATE_OTA_ERROR::UNKNOWN;
    }
...
UPDATE_OTA_ERROR UpdateOTA::updateSPIFFS(const char *url, const char *urlVersion, const char *currentVersion)
{
    ...
    {
        Log_Error(_logger, "Error updating SPIFFS");
        return UPDATE_OTA_ERROR::UNKNOWN;
    }
